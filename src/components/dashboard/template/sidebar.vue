...
<!-- {{bioData.data.profile}} -->
            ...
            <div class="card-body">
                <img class="wdd float-left mr-4 rounded mb-3" :src="bioData.data.profile.image" />


                <h4 class="mt-0 header-title">{{bioData.data.profile.firstname}} {{bioData.data.profile.lastname}}</h4>
